            ...
            if part.contains('=') {
                ...
                if !key.contains(' ') {
                    ...
                    match key.as_str() {
                        ...
                        "num_values" => match value.parse::<usize>() {
                            Ok(num) => num_values = Some(num),
                            _ => {}
                        },
                        "delimiter" => {
                            if value.len() == 1 {
                        ...
                        "last" => last_arg_double_dash = str_to_bool(value).unwrap_or(false),
...
mod tests {
    ...
    mod from_source_file_header {
        ...
        fn default() {
            ...
            assert_eq!(details.autocompletion, false);
            assert_eq!(details.syntax, None);
            assert_eq!(details.sync_update, false);
        }
        ...
        fn autocompletion() {
            ...
            assert_eq!(details.autocompletion, true);
        }
        ...
        fn argparser() {
            ...
            assert_eq!(details.argparser, true);
        }
        ...
        fn argparser_false() {
            ...
            assert_eq!(details.argparser, false);
        }
        ...
        fn sync_update() {
            ...
            assert_eq!(details.sync_update, true);
        }
        ...
        fn arg_with_type_array_string() {
            param_with_type(true, "array/string", SyntaxOptArgType::ArrayString);
        }

        #[test]
        fn arg_with_type_array_int() {
            param_with_type(true, "array/int", SyntaxOptArgType::ArrayInteger);
        }

        #[test]
        fn arg_with_type_array_integer() {
            param_with_type(true, "array/integer", SyntaxOptArgType::ArrayInteger);
        }

        #[test]
        fn arg_with_type_array_float() {
            param_with_type(true, "array/float", SyntaxOptArgType::ArrayFloat);
        }

        #[test]
        fn arg_with_type_array_bool() {
            param_with_type(true, "array/bool", SyntaxOptArgType::ArrayBoolean);
        }

        #[test]
        fn arg_with_type_array_boolean() {
            param_with_type(true, "array/boolean", SyntaxOptArgType::ArrayBoolean);
        }
