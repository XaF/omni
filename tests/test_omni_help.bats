...
# bats test_tags=generate,omni:help
@test "[omni_help=10] omni help config path shows the help message for the command" {
  validate_test_output omni/help-config-path.txt skip_lines=1 omni help config path
}

# bats test_tags=generate,omni:help
@test "[omni_help=11] omni help config path switch shows the help message for the command" {
  validate_test_output omni/help-config-path-switch.txt skip_lines=1 omni help config path switch
}

# bats test_tags=generate,omni:help
@test "[omni_help=12] omni help config reshim shows the help message for the command" {
  validate_test_output omni/help-config-reshim.txt skip_lines=1 omni help config reshim
}

# bats test_tags=generate,omni:help
@test "[omni_help=13] omni help config trust shows the help message for the command" {
  validate_test_output omni/help-config-trust.txt skip_lines=1 omni help config trust
}

# bats test_tags=generate,omni:help
@test "[omni_help=14] omni help config untrust shows the help message for the command" {
  validate_test_output omni/help-config-untrust.txt skip_lines=1 omni help config untrust
}

# bats test_tags=generate,omni:help
@test "[omni_help=15] omni help help shows the help message for the command" {
  validate_test_output omni/help-help.txt skip_lines=1 omni help help
}

# bats test_tags=generate,omni:help
@test "[omni_help=16] omni help hook shows the help message for the command" {
  validate_test_output omni/help-hook.txt skip_lines=1 omni help hook
}

# bats test_tags=generate,omni:help
@test "[omni_help=17] omni help hook env shows the help message for the command" {
  validate_test_output omni/help-hook-env.txt skip_lines=1 omni help hook env
}

# bats test_tags=generate,omni:help
@test "[omni_help=18] omni help hook init shows the help message for the command" {
  validate_test_output omni/help-hook-init.txt skip_lines=1 omni help hook init
}

# bats test_tags=generate,omni:help
@test "[omni_help=19] omni help hook uuid shows the help message for the command" {
  validate_test_output omni/help-hook-uuid.txt skip_lines=1 omni help hook uuid
}

# bats test_tags=generate,omni:help
@test "[omni_help=20] omni help status shows the help message for the command" {
  validate_test_output omni/help-status.txt skip_lines=1 omni help status
}

# bats test_tags=generate,omni:help
@test "[omni_help=21] omni help cd shows the help message for the command" {
  validate_test_output omni/help-cd.txt skip_lines=1 omni help cd
}

# bats test_tags=generate,omni:help,omni:help:json
@test "[omni_help=22] omni help cd shows in JSON the help message for the command" {
  validate_test_output omni/help-cd-json.txt omni help -o json cd
}

# bats test_tags=generate,omni:help
@test "[omni_help=23] omni help clone shows the help message for the command" {
  validate_test_output omni/help-clone.txt skip_lines=1 omni help clone
}

# bats test_tags=generate,omni:help
@test "[omni_help=24] omni help down shows the help message for the command" {
  validate_test_output omni/help-down.txt skip_lines=1 omni help down
}

# bats test_tags=generate,omni:help
@test "[omni_help=25] omni help scope shows the help message for the command" {
  validate_test_output omni/help-scope.txt skip_lines=1 omni help scope
}

# bats test_tags=generate,omni:help
@test "[omni_help=26] omni help tidy shows the help message for the command" {
  validate_test_output omni/help-tidy.txt skip_lines=1 omni help tidy
}

# bats test_tags=generate,omni:help,omni:help:up
@test "[omni_help=27] omni help up shows the help message for the command" {
...
@test "[omni_help=28] omni help up shows in JSON the help message for the command" {
...
# bats test_tags=generate,omni:help,omni:help:self
@test "[omni_help=29] omni help shows the help message with a very long config command (columns=1000)" {
  setup_very_long_config_command
  export COLUMNS=1000
...
# bats test_tags=generate,omni:help,omni:help:self
@test "[omni_help=30] omni help shows the help message with a very long config command (columns=100)" {
  setup_very_long_config_command
  export COLUMNS=100
  validate_test_output omni/help-long-config-command-${COLUMNS}.txt skip_lines=1 omni help
}
...
# bats test_tags=generate,omni:help,omni:help:self
@test "[omni_help=31] omni help shows the help message with a very long config command (columns=50)" {
  setup_very_long_config_command
  export COLUMNS=50
  validate_test_output omni/help-long-config-command-${COLUMNS}.txt skip_lines=1 omni help
}
...
# bats test_tags=generate,omni:help,omni:help:self
@test "[omni_help=32] omni help fails to show the help message if terminal width is too low (columns=10)" {
  setup_very_long_config_command
  export COLUMNS=10
...
# bats test_tags=generate,omni:help
@test "[omni_help=33] omni help shows command parameters in the help message of a custom command" {
  local omni_config="${HOME}/.config/omni/config.yaml"
  mkdir -p "$(dirname "$omni_config")"
  cat <<EOF >>"$omni_config"
commands:
